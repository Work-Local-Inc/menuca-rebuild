...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        if (z2) {
            ...
            width = iMax2 + ((i == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i6);
        }
        int i12 = 1;
        if (i == 1) {
            ...
            while (it3.hasNext()) {
                ...
                if (i6 == i12) {
                    ...
                    i9 = i5;
                    iMax3 = Math.max(iMax3, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, (baselineDistance * i6) + i11));
                }
                it3 = it4;
                i5 = i9;
                i12 = 1;
            ...
            i7 = i5;
            int i13 = iMax3;
            i8 = (constraintWidget.mBaseline.getResolutionNode().dependents.size() <= 0 || z2) ? i13 : i6 == 1 ? i13 + height : i13 - baselineDistance;
        } else {
            i7 = i5;
            i8 = 0;
        }
