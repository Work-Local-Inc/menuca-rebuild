...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (this.mOrientation == 1 && (i = this.mGravity & com.cojotech.commission.menu.restotool.R.styleable.AppCompatTheme_windowActionBarOverlay) != 48) {
            if (i == 16) {
    ...
    */
    ...
    public void setGravity(int i) {
        if (this.mGravity != i) {
            ...
            if ((i & com.cojotech.commission.menu.restotool.R.styleable.AppCompatTheme_windowActionBarOverlay) == 0) {
                i |= 48;
            }
            this.mGravity = i;
            requestLayout();
    ...
    public void setVerticalGravity(int i) {
        ...
        int i3 = this.mGravity;
        if ((i3 & com.cojotech.commission.menu.restotool.R.styleable.AppCompatTheme_windowActionBarOverlay) != i2) {
