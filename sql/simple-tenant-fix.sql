-- 🎯 SIMPLE TENANT FIX - Add tenant_id to menu_items
-- This is the proper enterprise solution vs removing it from API
...
-- 4. MENU_ITEMS table - WITH tenant_id (proper enterprise approach)
CREATE TABLE public.menu_items (
  id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
  category_id uuid NOT NULL REFERENCES public.menu_categories(id) ON DELETE CASCADE,
  tenant_id text NOT NULL DEFAULT 'default-tenant', -- THE FIX!
  name text NOT NULL,
...
SELECT 'Schema with tenant_id fix created - API will work as originally intended!' as status;
