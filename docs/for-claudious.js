yeah "Client-side JavaScript to manage the cart (stored in browser localStorage/sessionStorage)" 100% thats why im logged out and cart is cleared when you open a new browser window lol 
  common man catch up here your the big brain one. And i dont know how many times i have said theres no api that i know of and you have even confirmned this on more than 1 occasion then you 
  start going on about api api api api but as i open my mouth i see when I add an item to cart "var StripeM = function(e) {
      var t = {};
      function n(r) {
          if (t[r])
              return t[r].exports;
              ...
              n = 0; n < u.length; ) {
                  ...
                  t = 0; t < 64; t += 1) {
                      var b = v[t - 15]
                        ...
                        , p = f[0]
                        , m = f[4]
                        , O = f[7] + (_(m, 6) ^ _(m, 11) ^ _(m, 25)) + (m & f[5] ^ ~m & f[6]) + s[t] + (v[t] = t < 16 ? v[t] : v[t - 16] + (_(b, 7) ^ _(b, 18) ^ b >>> 3) + v[t - 7] + (_(R, 
  17) ^ _(R, 19) ^ R >>> 10) | 0);
  ...
  , function(e, t, n) {
      ...
      (function(e) {
          ...
          var R = [T("CookieSupportExtractor"), T("DoNotTrackExtractor"), T("LanguageExtractor"), T("PlatformExtractor"), T("PluginsExtractor"), T("ScreenSizeExtractor"), 
  T("TimeZoneOffsetExtractor"), T("TouchSupportExtractor"), T("AvailableStorageExtractor"), T("FontsExtractor"), T("GraphicsConfigurationExtractor"), T("UserAgentExtractor"), 
  T("FlashVersionExtractor"), T("HasAdBlocker"), T("CanvasIdExtractor")];
          function p() {
              try {
                  if (e)
                      return e
  ...
  , function(e, t, n) {
      ...
      (function(e) {
          ...
          var a = [["Andale Mono", "mono"], ["Arial Black", "sans"], ["Arial Hebrew", "sans"], ["Arial MT", "sans"], ["Arial Narrow", "sans"], ["Arial Rounded MT Bold", "sans"], ["Arial 
  Unicode MS", "sans"], ["Arial", "sans"], ["Bitstream Vera Sans Mono", "mono"], ["Book Antiqua", "serif"], ["Bookman Old Style", "serif"], ["Calibri", "sans"], ["Cambria", "serif"], 
  ["Century Gothic", "serif"], ["Century Schoolbook", "serif"], ["Century", "serif"], ["Comic Sans MS", "sans"], ["Comic Sans", "sans"], ["Consolas", "mono"], ["Courier New", "mono"], 
  ["Courier", "mono"], ["Garamond", "serif"], ["Georgia", "serif"], ["Helvetica Neue", "sans"], ["Helvetica", "sans"], ["Impact", "sans"], ["Lucida Fax", "serif"], ["Lucida Handwriting", 
  "script"], ["Lucida Sans Typewriter", "mono"], ["Lucida Sans Unicode", "sans"], ["Lucida Sans", "sans"], ["MS Gothic", "sans"], ["MS Outlook", "symbol"], ["MS PGothic", "sans"], ["MS 
  Reference Sans Serif", "sans"], ["MS Serif", "serif"], ["MYRIAD PRO", "sans"], ["MYRIAD", "sans"], ["Microsoft Sans Serif", "sans"], ["Monaco", "sans"], ["Monotype Corsiva", "script"], 
  ["Palatino Linotype", "serif"], ["Palatino", "serif"], ["Segoe Script", "script"], ["Segoe UI Semibold", "sans"], ["Segoe UI Symbol", "symbol"], ["Segoe UI", "sans"], ["Tahoma", "sans"], 
  ["Times New Roman PS", "serif"], ["Times New Roman", "serif"], ["Times", "serif"], ["Trebuchet MS", "sans"], ["Verdana", "sans"], ["Wingdings 3", "symbol"], ["Wingdings", "symbol"]]
